# https://jv.umsa.bo/oj/problem.php?cid=2870&pid=46
## https://jv.umsa.bo/oj/problem.php?id=1213
...
#   Entrada
#    Primero debes leer un entero t ($1 \leq t \leq 10^4$) que indica la cantidad de casos de entrada. Luego por cada caso de entrada debes leer un N ($0 \leq N \leq 1000000000 $).
#   Salida
