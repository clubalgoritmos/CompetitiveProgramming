# https://jv.umsa.bo/oj/problem.php?cid=2870&pid=64
## https://jv.umsa.bo/oj/problem.php?id=1355
#    Copiado al portapapeles
#  Círculo de amistad
#  Enviar
#  Estado
#  Descripción
#    Los chicos y chicas de INF-111 tienen un problema./*No, no creas, no estan estudiando.*/ Ell@s quieren formar un circulo de amistad (literalmente un círculo) pero son algo sangron@s, no quieren que en el círculo entre algun "desconocido"... es decir, quieren que en el círculo todos se consideren amigos entre si. Se define que, si una persona A se considera aamig@ de una persona B y B se considera amig@ de C entonces A se considera amig@ de C.Si A se considera amig@ de B no se garantiza que B se considere o no amig@ de A (repito, sangron@s).Cada chico y chica tiene una persona a la que se considera su mejor amig@, si pudieras cambiar la elección de el/la mejor amig@ de una persona, ¿cuál es el máximo número de personas en el círculo de amistad que se puede formar?
