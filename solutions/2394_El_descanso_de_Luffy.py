# https://jv.umsa.bo/oj/problem.php?cid=2870&pid=204
## https://jv.umsa.bo/oj/problem.php?id=2394
#    Copiado al portapapeles
#  El descanso de Luffy
#  Enviar
#  Estado
#  Descripción
#    Después de un largo día de escapar de la marina, la tripulación pirata sombrero de paja necesita descansar.
#    Los $n$ miembros de la tripulación planean pasar la noche en el barco de Luffy (El capitan de la tripulación sombrero de paja). Luffy tiene $n$ camas en una fila y $m$ almohadas $(n\leqm)$. Cada miembro de la tripulación necesita una cama y al menos una almohada para dormir, sin embargo, todos quieren tantas almohadas como sea posible. Por supuesto, no siempre es posible compartir almohadas por igual, pero cualquier miembro de la tripulación sale lastimado si tiene al menos $2$ almohadas menos que algunos de sus vecinos adyacentes.
...
#    Para cada caso contendrá $3$ números enteros en la misma línea: $n$, $m$ y $k$ $(1\leqn\leqm\leq10^{9}, 1\leqk\leqn)$ — el número de tripulantes, el número de almohadas y el número de la cama en la que dormirá Luffy.
#   Salida
