# https://jv.umsa.bo/oj/problem.php?cid=2815&pid=4
#  DPA
#  Enviar
#  Estado
#  Descripción
...
#    Por ejemplo los divisores propios positivos de 6 son 1, 2 y 3 la suma da 6 que es igual a 6 por lo que es un número perfecto.
#   Entrada
#    La entrada consiste en varios casos de prueba donde cada caso ccontiene un entero$n$ ( $1 \leq n \leq 100$)
#    La entrada consiste en varios casos de prueba donde cada caso ccontiene un entero$n$ ( $1 \leq n \leq 100$)
#    La entrada consiste en varios casos de prueba donde cada caso ccontiene un entero
#    $n$ ( $1 \leq n \leq 100$)
#   Salida
