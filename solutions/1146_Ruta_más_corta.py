# https://jv.umsa.bo/oj/problem.php?cid=2870&pid=24
## https://jv.umsa.bo/oj/problem.php?id=1146
#    Copiado al portapapeles
#  Ruta más corta
#  Enviar
#  Estado
#  Descripción
#    Eres un cartógrafo y tienes la misión de determinar cuál ruta es más corta. Una carretera de un solo carril esta descrita por un – y una carretera de dos carriles por = abas de valor 1. Los destinos son ciudades C o pueblos P que tambien valen 1. Una Ruta está definida por – o = secuencialesdel mismo tipo no se consideran combinacioneslas cuales deben llegar a un C o P, por ejemplo -P----==C====P---C--P la ruta corta será 2. Tu objetivo es determinar cuál es la ruta más corta. Combinar CC, PP, CP y PC no cuenta como ruta de tamaño 1, salvo la cadena sea de exlusivamente compuesta de C y P por ejemplo esta ruta es de tamaño 2 --CCC=PCPC .
#   Entrada
