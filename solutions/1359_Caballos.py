# https://jv.umsa.bo/oj/problem.php?cid=2870&pid=67
## https://jv.umsa.bo/oj/problem.php?id=1359
...
#   Entrada
#    Se te darán varios casos de prueba donde:La primera linea de cada caso de prueba tendrá dos números enteros $n,m$ $(1 <= n,m <= 5*10^2)$ - las dimensiones del tablero de juego.
#    Seguidamente n lineas con m caracteres que representa el tablero de juego. Donde 'K' determina un ficha de caballo, 'B' una ficha de alfil, 'T' una ficha de peón, '.' un lugar vació. Los diferentes premios estarán asignados con dígitos del 0 al 9.
...
#   Ejemplo Entrada
#    4 4 ...2 .T.T .T.B .K.. 4 4...2 .9.T .T.B .K.. 0 0
#   Ejemplo Salida
#    Caso #1: 2Caso #2: 11
#   Ayuda
